...
mod x86_64 {
    ...
    impl DebugAddressRegister for Dr0 {
        ...
        fn read() -> VirtAddr {
            ...
            unsafe {
                addr = crate::asm::x86_64_asm_read_dr0();
            }
        ...
        fn write(addr: VirtAddr) {
            ...
            #[cfg(not(feature = "inline_asm"))]
            unsafe {
                crate::asm::x86_64_asm_write_dr0(addr.as_u64());
            }
        }
    }
    ...
    impl DebugAddressRegister for Dr1 {
        ...
        fn read() -> VirtAddr {
            ...
            #[cfg(not(feature = "inline_asm"))]
            unsafe {
                addr = crate::asm::x86_64_asm_read_dr1();
            }
        ...
        fn write(addr: VirtAddr) {
            ...
            #[cfg(not(feature = "inline_asm"))]
            unsafe {
                crate::asm::x86_64_asm_write_dr1(addr.as_u64());
            }
        }
    }
    ...
    impl DebugAddressRegister for Dr2 {
        ...
        fn read() -> VirtAddr {
            ...
            #[cfg(not(feature = "inline_asm"))]
            unsafe {
                addr = crate::asm::x86_64_asm_read_dr2();
            }
        ...
        fn write(addr: VirtAddr) {
            ...
            #[cfg(not(feature = "inline_asm"))]
            unsafe {
                crate::asm::x86_64_asm_write_dr2(addr.as_u64());
            }
        }
    }
    ...
    impl DebugAddressRegister for Dr3 {
        ...
        fn read() -> VirtAddr {
            ...
            #[cfg(not(feature = "inline_asm"))]
            unsafe {
                addr = crate::asm::x86_64_asm_read_dr3();
            }
        ...
        fn write(addr: VirtAddr) {
            ...
            #[cfg(not(feature = "inline_asm"))]
            unsafe {
                crate::asm::x86_64_asm_write_dr3(addr.as_u64());
            }
        }
    }
    ...
    impl Dr6 {
        ...
        pub fn read_raw() -> u64 {
            ...
            #[cfg(not(feature = "inline_asm"))]
            unsafe {
                value = crate::asm::x86_64_asm_read_dr6();
            }
    ...
    impl Dr7 {
        ...
        pub fn read_raw() -> u64 {
            ...
            #[cfg(not(feature = "inline_asm"))]
            unsafe {
                value = crate::asm::x86_64_asm_read_dr7();
            }
        ...
        pub fn write_raw(value: u64) {
            ...
            #[cfg(not(feature = "inline_asm"))]
            unsafe {
                crate::asm::x86_64_asm_write_dr7(value);
            }
        }
    }
}
